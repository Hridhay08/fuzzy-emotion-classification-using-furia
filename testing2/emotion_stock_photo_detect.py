...
image_paths = ["anger.png", "contempt.jpeg", "disgust.jpeg", "fear.jpg", "happiness.jpg", "neutral.jpg", "sadness.jpg", "surprise.jpg"]
...
for image_path in image_paths:
    ...
    for (i, rect) in enumerate(rects):
        ...
        new_file_name = file_name+'_emotion_detected.'+extension
